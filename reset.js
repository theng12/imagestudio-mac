  ...
  run: [
    ...
    },
    {
      ...
      params: {
        ...
        message: "python -c \"from backend.auto_update_config import create_updater; create_updater().save_settings({'mode':'off','frequency':'daily','maintenance_hour':4,'idle_only':True})\""
      }
    },
    {
