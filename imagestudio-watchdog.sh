#!/bin/bash
#
# Image Studio KH — health watchdog for the always-on server.
#
...
#
PORT=47868
LABEL="com.kh.imagestudio.server"
ROOT="$(cd "$(dirname "$0")" && pwd)"
FAILURE_FILE="${IMAGESTUDIO_WATCHDOG_STATE_FILE:-$ROOT/service/.watchdog-failures}"
FAILURES_REQUIRED="${IMAGESTUDIO_WATCHDOG_FAILURES_REQUIRED:-3}"
CURL_BIN="${IMAGESTUDIO_WATCHDOG_CURL_BIN:-curl}"
LAUNCHCTL_BIN="${IMAGESTUDIO_WATCHDOG_LAUNCHCTL_BIN:-launchctl}"
