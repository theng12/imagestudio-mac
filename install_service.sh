#!/bin/bash
#
# Install Image Studio KH as an always-on macOS service (launchd LaunchAgent).
#
...
SRV="com.kh.imagestudio.server"
WD="com.kh.imagestudio.watchdog"
PORT=47868
...
<dict>
  ...
  <array><string>$ROOT/imagestudio-serve.sh</string></array>
...
<dict>
  ...
  <key>ProgramArguments</key>
  <array><string>$ROOT/imagestudio-watchdog.sh</string></array>
  <key>RunAtLoad</key><true/>
