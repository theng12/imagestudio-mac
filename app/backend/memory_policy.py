...
# Image throughput was unchanged, while the next Voice job on an M4 16 GB fell
# from 52.7 s to 4.0 s once Image released immediately. An operator's explicit
# choice, persisted in memory_policy.json, always wins.
